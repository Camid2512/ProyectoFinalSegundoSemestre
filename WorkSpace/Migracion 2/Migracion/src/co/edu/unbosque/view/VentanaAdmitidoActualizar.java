...
public class VentanaAdmitidoActualizar extends JFrame {
	...
	private JTextField index, numDocumento, nombreCompleto, ciudadOrigen, diaNacimiento, mesNacimiento, anoNacimiento,
			pais, diaEntrada, mesEntrada, anoEntrada, horaEntrada, minutoEntrada, diasEstadia;
	...
	public VentanaAdmitidoActualizar() {
		...
		texto0 = new JLabel();
		texto0.setText("INGRESE LA POSICION DE LA PERSONA ADMITIDA QUE DESEA ACTUALIZAR");
		texto0.setBounds(0, 480, 450, 15);
		add(texto0);

		index = new JTextField();
		index.setBounds(455, 475, 30, 30);
		add(index);
		...
		actualizar.setBounds(225, 515, 120, 50);
		add(actualizar);
