...
public class VentanaNoAdmitidoActualizar extends JFrame {

	private JTextField index, numDocumento, nombreCompleto, ciudadOrigen, diaNacimiento, mesNacimiento, anoNacimiento,
			pais, ciudadDevolucion, diaExpulsion, mesExpulsion, anoExpulsion, motivoExpulsion;
	private JLabel texto0, texto1, texto2, texto3, texto4, texto5, texto6, texto7, texto8, texto9, texto10, texto11,
			texto12;
	private JButton guardar;

	public VentanaNoAdmitidoActualizar() {
		...
		texto0 = new JLabel();
		texto0.setText("INGRESE LA POSICION DE LA PERSONA NO ADMITIDA QUE DESEA ACTUALIZAR");
		texto0.setBounds(0, 480, 470, 15);
		add(texto0);

		index = new JTextField();
		index.setBounds(485, 475, 30, 30);
		add(index);
		...
		texto4 = new JLabel();
		texto4.setText("Ingrese su NUEVA Fecha de nacimiento");
		...
		texto7 = new JLabel();
		texto7.setText("Ingrese NUEVO el Pais");
		...
		texto8 = new JLabel();
		texto8.setText("Ingrese la NUEVA ciudad de devolucion");
		...
		texto8 = new JLabel();
		texto8.setText("Ingrese la NUEVA Fecha de devolucion");
		...
		texto12 = new JLabel();
		texto12.setText("Ingrese el NUEVO motivo de expulsion");
		...
		guardar.setBounds(225, 525, 110, 50);
		add(guardar);
