...
public class MilitarLocalUpdateWindow extends JFrame {
	/**
	...
	private static final long serialVersionUID = 2287055149619624443L;
	 ...
	 * @since 28/09/2023
	 */
	private JTextField docTxt, nameTxt, dayBirthTxt, monthBirthTxt, yearBirthTxt, rankTxt, serviceTimeTxt, indexTxt;
	/**
	...
	public MilitarLocalUpdateWindow() {
		...
		helpImage3.setToolTipText("INGRESE SU RANGO");

		helpImage4 = new JLabel();
		helpImage4.setBounds(660, 422, 35, 35);
		helpImage4.setToolTipText("INGRESE LOS MESES DE SERVICIO PARA EL EJERCITO");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/10.png").getImage();
	...
	/**
	 * Este es el getter de el campo de rango
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el setter de el campo de rango
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el getter de el campo de tiempo de servicio
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el setter de el campo de tiempo de servicio
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
