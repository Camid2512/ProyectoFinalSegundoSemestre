...
/** 
 * Esta es la clase ventana de actualizar civil
...
public class MilitarForeignUpdateWindow extends JFrame {
	...
	private static final long serialVersionUID = -3815133356089320079L;
	...
	/**
	 * Estos son los atributos de los campos de textos
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	 */
	private JTextField docTxt, nameTxt, dayBirthTxt, monthBirthTxt, yearBirthTxt, countryOriginTxt, timeCountryTxt,
			indexTxt;
	 ...
	 * @since 28/09/2023
	 */
	private JButton backBtn, updateBtn, fileChooserBtn;

	/**
	 * Este es el constructor vacio de la ventana actualizar civil
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	public MilitarForeignUpdateWindow() {
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("UPDATE CIVIL");
		...
		updateBtn.setBounds(445, 598, 345, 95);
		updateBtn.setToolTipText("Boton que permite la actualizacion de un CIVIL");
		...
		countryOriginTxt = new JTextField();
		countryOriginTxt.setBounds(58, 365, 309, 70);
		countryOriginTxt.setBackground(new Color(0, 0, 0, 0));
		countryOriginTxt.setOpaque(false);
		countryOriginTxt.setBorder(new EmptyBorder(15, 15, 15, 15));
		countryOriginTxt.setFont(new Font("Arial", 1, 25));
		countryOriginTxt.setForeground(Color.white);
		add(countryOriginTxt);

		timeCountryTxt = new JTextField();
		timeCountryTxt.setBounds(538, 404, 100, 65);
		timeCountryTxt.setBackground(new Color(0, 0, 0, 0));
		timeCountryTxt.setOpaque(false);
		timeCountryTxt.setBorder(new EmptyBorder(15, 15, 15, 15));
		timeCountryTxt.setFont(new Font("Arial", 1, 40));
		timeCountryTxt.setForeground(Color.white);
		add(timeCountryTxt);
		...
		indexTxt.setBounds(625, 523, 160, 52);
		indexTxt.setBackground(new Color(0, 0, 0, 0));
		indexTxt.setOpaque(false);
		indexTxt.setBorder(new EmptyBorder(15, 15, 15, 15));
		indexTxt.setFont(new Font("Arial", 1, 30));
		indexTxt.setForeground(Color.white);
		add(indexTxt);
		...
		helpImage2.setToolTipText("INGRESE SU NOMBRE COMPLETO");
		...
		helpImage6.setToolTipText("INSERTE SU FOTO");

		helpImage7 = new JLabel();
		helpImage7.setBounds(794, 530, 35, 35);
		helpImage7.setToolTipText("INSERTE LA POSICION A ACTUALIZAR");
		...
		helpImage7.setIcon(img2);
		helpImage7.setVisible(true);
		add(helpImage7);
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/11.png").getImage();
	...
	/**
	 * Este es el setter de la imagen ayuda 4
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el getter de la imagen ayuda 7
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	public JLabel getHelpImage7() {
		return helpImage7;
	}

	/**
	 * Este es el setter de la imagen ayuda 7
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	public void setHelpImage7(JLabel helpImage7) {
		this.helpImage7 = helpImage7;
	}
	...
	/**
	 * Este es el getter de el campo de indice
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	public JTextField getIndexTxt() {
		return indexTxt;
	}
	
	/**
	 * Este es el getter de el campo de pais de origen
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	public JTextField getCountryOriginTxt() {
		return countryOriginTxt;
	}

	/**
	 * Este es el setter de el campo de pais de origen
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	 */
	public void setCountryOriginTxt(JTextField countryOriginTxt) {
		this.countryOriginTxt = countryOriginTxt;
	}
	/**
	 * Este es el getter de el campo de tiempo en nuestro pais
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	public JTextField getTimeCountryTxt() {
		return timeCountryTxt;
	}
	/**
	 * Este es el setter de el campo de tiempo en nuestro pais
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	public void setTimeCountryTxt(JTextField timeCountryTxt) {
		this.timeCountryTxt = timeCountryTxt;
	}
	/**
	 * Este es el setter de el campo de index
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	public void setIndexTxt(JTextField indexTxt) {
		this.indexTxt = indexTxt;
	}
	
	/**
	 * Este es el getter de el boton volver
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el setter de el boton volver
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el getter de el boton actualizar
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el setter de el boton actualizar
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el getter de el boton jfilechooser
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el setter de el boton jfilechooser
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
