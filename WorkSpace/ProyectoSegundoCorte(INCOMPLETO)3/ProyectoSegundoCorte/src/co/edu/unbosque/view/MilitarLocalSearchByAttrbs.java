...
public class MilitarLocalSearchByAttrbs extends JFrame {
	/**
	 ...
	 * @since 28/09/2023
	 */
	private static final long serialVersionUID = -6474176182223542137L;
	/**
	...
	public MilitarLocalSearchByAttrbs() {
		...
		helpImage.setToolTipText("VENTANA PARA BUSQUEDA POR ATRIBUTOS DE MILITAR LOCAL");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/14.png").getImage();
