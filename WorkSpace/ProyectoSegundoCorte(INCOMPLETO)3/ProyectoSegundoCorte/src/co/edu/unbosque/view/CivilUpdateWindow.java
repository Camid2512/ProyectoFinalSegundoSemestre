...
public class CivilUpdateWindow extends JFrame {
	...
	private static final long serialVersionUID = -1358539116277499631L;
	 ...
	 * @since 28/09/2023
	 */
	private JTextField docTxt, nameTxt, dayBirthTxt, monthBirthTxt, yearBirthTxt, studiesTxt, timeArmyTxt, indexTxt;
	...
	public CivilUpdateWindow() {
		...
		studiesTxt = new JTextField();
		studiesTxt.setBounds(58, 365, 309, 70);
		studiesTxt.setBackground(new Color(0, 0, 0, 0));
		studiesTxt.setOpaque(false);
		studiesTxt.setBorder(new EmptyBorder(15, 15, 15, 15));
		studiesTxt.setFont(new Font("Arial", 1, 25));
		studiesTxt.setForeground(Color.white);
		add(studiesTxt);

		timeArmyTxt = new JTextField();
		timeArmyTxt.setBounds(538, 404, 100, 65);
		timeArmyTxt.setBackground(new Color(0, 0, 0, 0));
		timeArmyTxt.setOpaque(false);
		timeArmyTxt.setBorder(new EmptyBorder(15, 15, 15, 15));
		timeArmyTxt.setFont(new Font("Arial", 1, 40));
		timeArmyTxt.setForeground(Color.white);
		add(timeArmyTxt);
		...
		helpImage3.setToolTipText("INGRESE SU NIVEL DE ESTUDIOS");

		helpImage4 = new JLabel();
		helpImage4.setBounds(660, 422, 35, 35);
		helpImage4.setToolTipText("INGRESE EL NUMERO DE MESES TRABAJANDO EN EL EJERCITO");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/9.png").getImage();
	...
	/**
	 * Este es el getter de el campo de estudios
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	 */
	public JTextField getStudiesTxt() {
		return studiesTxt;
	}
	
	/**
	 * Este es el setter de el campo de estudios
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	public void setStudiesTxt(JTextField studiesTxt) {
		this.studiesTxt = studiesTxt;
	}

	/**
	 * Este es el getter de el campo tiempo en el ejercito
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	 */
	public JTextField getTimeArmyTxt() {
		return timeArmyTxt;
	}
	/**
	 * Este es el setter de el campo tiempo en el ejercito
	...
	public void setTimeArmyTxt(JTextField timeArmyTxt) {
		this.timeArmyTxt = timeArmyTxt;
	}
	...
	/**
	 * Este es el getter de el boton de actualizar
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el setter de el boton de actualizar
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el getter de el boton de file chooser
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el setter de el boton de file chooser
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el setter de el campo de indice
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
