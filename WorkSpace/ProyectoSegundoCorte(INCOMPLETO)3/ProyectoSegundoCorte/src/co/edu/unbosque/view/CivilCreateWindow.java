...
/** 
 * Esta es la clase ventana de crear civil
...
public class CivilCreateWindow extends JFrame {
	...
	private static final long serialVersionUID = -2505193371333009529L;
	 ...
	 * @since 28/09/2023
	 */
	private JTextField docTxt, nameTxt, dayBirthTxt, monthBirthTxt, yearBirthTxt, studiesTxt, timeArmyTxt;
	/**
	...
	/**
	 * Este es el constructor vacio de la ventana crear civil
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	 */
	public CivilCreateWindow() {
		// TODO Auto-generated constructor stub

		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CREATE CIVIL");
		...
		createBtn.setToolTipText("Boton que permite la creacion de un CIVIL");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/6.png").getImage();
	...
	/**
	 * Este es el getter de el campo de foto
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el setter de el campo de foto
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el setter de el boton de crear
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
