...
public class MilitarForeignWindowCRUD extends JFrame {
	...
	/**
	 * Este es el constructor vacio de militar extranjero
	 * 
	 * @author Julian Garcia
	 * @version 1.0
	 * @since 26/09/2023
	 */
	public MilitarForeignWindowCRUD() {
		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("CRUD MILITAR EXTRANJERO");
		...
		createBtn.setToolTipText("Este boton nos lleva a crear un Militar Extranero");
		...
		readBtn.setToolTipText("Este boton nos lleva a ver una tabla de los Militares Extranjeros");
		...
		deleteBtn.setToolTipText("Este boton nos lleva a eliminar un Militar Extranjero");
		...
		updateBtn.setToolTipText("Este boton nos lleva a actualizar por posicion a un Militar Extranjero");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/5.png").getImage();
