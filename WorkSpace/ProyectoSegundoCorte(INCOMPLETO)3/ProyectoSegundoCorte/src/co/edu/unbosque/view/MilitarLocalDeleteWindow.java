...
/** 
 * Esta es la clase ventana de eliminar militar extranjero
...
public class MilitarLocalDeleteWindow extends JFrame {
	/**
	 ...
	 * @since 28/09/2023
	 */
	private static final long serialVersionUID = -8428648548411735275L;
	/**
	...
	/**
	 * Este es el constructor vacio de la ventana eliminar militar extranjero
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	public MilitarLocalDeleteWindow() {
		// TODO Auto-generated constructor stub

		setSize(1280, 720);
		setResizable(false);
		setLocationRelativeTo(null);
		setTitle("DELETE MILITAR LOCAL");
		...
		delteBtn.setToolTipText("Boton que permite la eliminacion de un MILITAR LOCAL");
		...
		helpImage.setToolTipText("VENTANA PARA ELIMINACION DE MILITAR LOCAL");
