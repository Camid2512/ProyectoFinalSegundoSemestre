...
public class MilitarForeignCreateWindow extends JFrame {
	...
	/**
	 * Este es el constructor vacio de la ventana crear militar extranjero
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el getter de el campo pais de origen
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	/**
	 * Este es el setter de el campo pais de origen
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
