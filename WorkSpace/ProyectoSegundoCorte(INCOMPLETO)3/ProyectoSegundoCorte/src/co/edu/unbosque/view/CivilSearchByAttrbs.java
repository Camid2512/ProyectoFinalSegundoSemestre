...
/** 
 * Esta es la clase ventana de buscar por atributo civil
...
public class CivilSearchByAttrbs extends JFrame {
	 ...
	 * @since 28/09/2023
	 */
	private static final long serialVersionUID = -5130001092440396123L;
	...
	/**
	 * Este es el constructor vacio de la ventana buscar por atributo civil
	 * 
	 * @author Cristhian Diaz
	 * @version 1.0
	 * @since 28/09/2023
	...
	public CivilSearchByAttrbs() {
		...
		helpImage.setToolTipText("VENTANA PARA BUSQUEDA POR ATRIBUTOS DE CIVIL");
		...
		Image temporal1;
		temporal1 = new ImageIcon("src/Images/13.png").getImage();
