...
/** 
 * Esta es la clase ventana de mostrar militar extranjero
...
public class MilitarForeignShowWindow extends JFrame {
	 ...
	 * @since 28/09/2023
	 */
	private static final long serialVersionUID = -4442993693437339500L;
	 ...
	 * @since 28/09/2023
	 */
	private MilitarForeignTable tablePanel = new MilitarForeignTable();
	 ...
	 * @since 28/09/2023
	 */
	public MilitarForeignShowWindow() {
	...
	public MilitarForeignTable getTablePanel() {
		return tablePanel;
	}
	/**
	...
	public void setTablePanel(MilitarForeignTable tablePanel) {
