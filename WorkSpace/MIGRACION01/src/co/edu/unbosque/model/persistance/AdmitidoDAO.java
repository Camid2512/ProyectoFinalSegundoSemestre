...
public class AdmitidoDAO implements OperacionDAO{
	...
	public void crear(String... args) {
		...
		lista.add(new AdmitidoDTO(numDocumentoTemp, nombreCompletoTemp, diaNacimientoTemp, mesNacimientoTemp,
				...
				horaEntradaTemp, minutoEntradaTemp, diasEstadiaTemp));
	...
	public String calcularFechaSalida(int diaEntrada, int mesEntrada, int anoEntrada, int diasEstadia) {

		LocalDate fechaEntrada = LocalDate.of(anoEntrada, mesEntrada, diaEntrada);
		LocalDate fechaSalida = fechaEntrada.plusDays(diasEstadia);
		return "La fecha de saldida es: " + fechaSalida;
	}
