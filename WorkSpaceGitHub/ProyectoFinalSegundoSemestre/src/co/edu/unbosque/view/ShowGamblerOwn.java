...
public class ShowGamblerOwn extends JFrame {
	 ...
	 * @since 28/09/2023
	 */
	private GamblerTable tablePanel = new GamblerTable();
	...
	public GamblerTable getTablePanel() {
		return tablePanel;
	}
	...
	public void setTablePanel(GamblerTable tablePanel) {
