...
/**
 * Esta clase permite mostrar las sedes para el dueño
 * 
 * @author SOFTPYLSA
 * @version 1.0
 * @since 10/11/2023
 ...
 * @since 10/11/2023
 */
public class ShowVenueOwn extends JFrame {

	/**
	 * Este es el atributo de la version serial
	 */
	private static final long serialVersionUID = -1584181554540173993L;
	/**
	 ...
	 * @since 28/09/2023
	 */
	private VenueTable tablePanel = new VenueTable();
	...
	public VenueTable getTablePanel() {
		return tablePanel;
	}
	...
	public void setTablePanel(VenueTable tablePanel) {
